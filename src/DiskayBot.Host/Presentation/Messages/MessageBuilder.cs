...
namespace DiskayBot.Host.Presentation.Messages;
...
public class MessageBuilder {
    public static string StartMessage() {
        ...
        sb.Append(" <b>/settings</b>").AppendLine(" — настройки");
        sb.Append(" <b>/show_profile</b>").AppendLine(" — твой профиль");
    ...
    public static string AboutBot(string version) {
        ...
        sb.AppendLine("<b>Последние изменения (17.03.26):</b>");
        sb.AppendLine(" • Исправлена проблема истечения срока действия расписания в кэше, из-за которой расписание могло пропадать.");
        sb.AppendLine();
